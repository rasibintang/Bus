...
import Adapter.BusResultAdapter;
...
public class _g_BusResultActivity extends AppCompatActivity {
    Animation animation;
    ImageView back;
    private BusResultAdapter bingobas7_adapter;
    private ArrayList<BusResultModel> bingobas7_models;
    TextView down;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout._g_activity_bus_result);
    ...
    private void runAnimation(RecyclerView recyclerView2) {
        ...
        this.bingobas7_models.add(new BusResultModel("A/C Sleeper (2+1)"));
        this.bingobas7_models.add(new BusResultModel("A/C Sleeper (2+1)"));
        this.bingobas7_models.add(new BusResultModel("A/C Sleeper (2+1)"));
        this.bingobas7_models.add(new BusResultModel("A/C Sleeper (2+1)"));
        this.bingobas7_models.add(new BusResultModel("A/C Sleeper (2+1)"));
        ...
        this.bingobas7_adapter = new BusResultAdapter(this, this.bingobas7_models);
